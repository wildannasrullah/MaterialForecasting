...
$conne = mysqli_connect($servername, $username, $password,$db);
$connec = mysqli_connect($servername, $username, $password,$db);
$sim = mysqli_connect($serversim, $usernamesim, $passwordsim, $dbsim);
$simm = mysqli_connect($serversim, $usernamesim, $passwordsim, $dbsim);
// Check connection
if (!$conn) {
