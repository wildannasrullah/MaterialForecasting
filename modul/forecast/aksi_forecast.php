...
mysqli_query($conn, "INSERT INTO forecast VALUES (NULL, '$_POST[sod]','$_POST[cust]','$_POST[qty_so]','$_POST[mat_cod]','$_POST[del_date]', '$_SESSION[username]', NOW(), '$_SESSION[username]', NOW(), 'Open',NULL)");
	echo"
		<script>
